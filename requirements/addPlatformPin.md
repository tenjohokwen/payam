...
- The encryption secret is sourced from a new config property: payam.platform.pin-encryption-secret, backed by environment variable PLATFORM_PIN_ENCRYPTION_SECRET.
...
payam.platform.notification-email (single platform-level address).
