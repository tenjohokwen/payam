...
import com.softropic.payam.platform.security.contract.exception.JWTExpiredException;
import com.softropic.payam.platform.security.contract.exception.MissingClientIdException;
...
import static com.softropic.payam.platform.security.common.util.SecurityConstants.API_KEY_HEADER;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.BUS_ID;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.B_COOKIE;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.CLIENT_ID;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.DB_REFRESH_TOKEN;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.DB_REFRESH_TOKEN_INTERVAL;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.DISPLAY_NAME;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.GENDER;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.JWT_COOKIE_NAME;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.JWT_SESSION_COOKIE;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.JWT_TTL;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.ROLES;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.SESSION_ID;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.SESSION_REFRESH_COUNTDOWN;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.USER_COOKIE;
import static com.softropic.payam.platform.security.contract.exception.SecurityError.MISSING_JWT_DB_REFRESH_TOKEN;
import static com.softropic.payam.platform.security.contract.util.AuthoritiesConstants.ANONYMOUS;
...
import static com.softropic.payam.platform.security.common.util.SecurityConstants.ANONYMOUS_SESSION_COOKIE;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.LOGIN_INFO_ID;
import static com.softropic.payam.platform.security.common.util.SecurityConstants.OTP_TTL;
import static com.softropic.payam.platform.security.contract.exception.SecurityError.MISSING_JWT_PRINCIPAL;
