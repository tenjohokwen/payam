...
import com.softropic.payam.platform.security.api.KeyAndPasswordDto;
...
public class PasswordResetIT {
    ...
    void testFinishPasswordReset_WithInvalidKey() {
        ...
        assertThatThrownBy(() -> accountManagementFacade.finishPasswordReset(keyAndPasswordDto))
                .isInstanceOf(com.softropic.payam.platform.security.contract.exception.OperationNotAllowedException.class);
    }
