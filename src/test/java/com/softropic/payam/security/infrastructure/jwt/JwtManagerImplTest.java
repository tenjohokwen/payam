...
import com.softropic.payam.security.config.SimpleGrantedAuthorityMixin;
import com.softropic.payam.security.common.util.CookieUtil;
import com.softropic.payam.security.contract.Principal;
import com.softropic.payam.security.contract.exception.InvalidJWTDataException;
import com.softropic.payam.security.contract.exception.JWTExpiredException;
import com.softropic.payam.security.contract.exception.MissingClientIdException;
...
import com.softropic.payam.security.service.SecretService;
...
import static com.softropic.payam.security.contract.exception.SecurityError.MISSING_JWT_DB_REFRESH_TOKEN;
import static com.softropic.payam.security.contract.util.AuthoritiesConstants.ANONYMOUS;
...
import static com.softropic.payam.security.contract.exception.SecurityError.MISSING_JWT_PRINCIPAL;
