package com.softropic.payam.platform.admin.repo;
...
public class PlatformConfig extends AbstractAuditingEntity {
     ...
     * Called by {@link com.softropic.payam.platform.admin.service.PlatformConfigService#update}
     ...
     *
     * <p>Called by {@link com.softropic.payam.platform.admin.service.PlatformConfigService#update}
     * within a transaction; JPA dirty-checking persists the change on commit.
     *
