...
import static com.softropic.payam.platform.security.contract.exception.SecurityError.FAULTY_JWT_ROLES_CLAIMS;
...
public class TokenCreatorImpl implements TokenCreator {
    ...
    private String getClientId(final boolean isLoggedIn) {
        ...
        throw new com.softropic.payam.platform.security.contract.exception.MissingClientIdException(msg);
    }
}
