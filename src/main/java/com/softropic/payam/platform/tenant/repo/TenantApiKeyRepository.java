package com.softropic.payam.platform.tenant.repo;
...
public interface TenantApiKeyRepository extends JpaRepository<TenantApiKey, Long> {
    ...
    @Query("""
        ...
        SET k.keyStatus = com.softropic.payam.platform.tenant.contract.ApiKeyStatus.REVOKED
        WHERE k.tenant.id = :tenantId
          AND k.keyStatus IN (
              com.softropic.payam.platform.tenant.contract.ApiKeyStatus.ACTIVE,
              com.softropic.payam.platform.tenant.contract.ApiKeyStatus.ROTATED
          )
        """)
    ...
    @Query("""
        ...
        WHERE k.tenant.id = :tenantId
          ...
          AND k.keyStatus = com.softropic.payam.platform.tenant.contract.ApiKeyStatus.ROTATED
        """)
    ...
    @Query("""
        ...
        WHERE k.tenant.id = :tenantId
          AND k.environment = :environment
          AND k.keyStatus = com.softropic.payam.platform.tenant.contract.ApiKeyStatus.ACTIVE
        """)
    ...
    @Query("""
        SELECT k FROM TenantApiKey k
        WHERE k.keyStatus = com.softropic.payam.platform.tenant.contract.ApiKeyStatus.ROTATED
