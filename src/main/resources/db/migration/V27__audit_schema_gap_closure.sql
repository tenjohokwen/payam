...
-- 2. Payment/Transaction related Audit Tables (missing from main schema)
CREATE TABLE IF NOT EXISTS main.fraud_rule_aud (
    id                 BIGINT NOT NULL,
    rev                INTEGER NOT NULL REFERENCES main.revinfo(rev),
    revtype            SMALLINT,
...
CREATE TABLE IF NOT EXISTS main.fee_rule_aud (
    id                 BIGINT NOT NULL,
    rev                INTEGER NOT NULL REFERENCES main.revinfo(rev),
    revtype            SMALLINT,
    tenant_id          BIGINT,
...
CREATE TABLE IF NOT EXISTS main.msisdn_prefix_route_aud (
    id                 BIGINT NOT NULL,
    rev                INTEGER NOT NULL REFERENCES main.revinfo(rev),
    revtype            SMALLINT,
    prefix             VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS main.webhook_delivery_log_aud (
    id                 BIGINT NOT NULL,
    rev                INTEGER NOT NULL REFERENCES main.revinfo(rev),
    revtype            SMALLINT,
