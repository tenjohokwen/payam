...
- [x] **PIN-09**: Admin sees an optional PIN input field in the Add Provider dialog — same masked Quasar toggle pattern; no auto-mask timer (admin just entered the value)
